...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("employee_management_system/icons/add_employee.jpg"));
        id15.setIcon(img);
    ...
    void showData(String s){
        try{
            ...
            if(res.next()){
                ...
                t4.setText(res.getString(6));
                t5.setText(res.getString(7));
                t6.setText(res.getString(8));
                t7.setText(res.getString(9));
                t8.setText(res.getString(10));
                t9.setText(res.getString(11));
